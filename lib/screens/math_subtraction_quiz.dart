...
//   var timerInfo;
//   var q1 = List.generate(5, (_) => ran.nextInt(20) + 1);
//   var q2 = List.generate(5, (_) => ran.nextInt(20) + 1);
//   var scoreList = [
//     1,
//     1,
//     1,
...
//     }
//   }
// // to check the answer, if text typed from textfield and correct answer is matched
...
//                     Text('Get the product of:',style: GoogleFonts.raleway(color: colorStyleOri1, fontSize: 20, fontWeight: FontWeight.bold),),
//                     Text('${q1[index]} x ${q2[index]}',style: GoogleFonts.raleway(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),),
//                     Padding(padding: EdgeInsets.all(20)),
//                     AnswerField(txt),
//                     Row(
//                       mainAxisAlignment: MainAxisAlignment.center,
